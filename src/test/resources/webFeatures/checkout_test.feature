Feature: Checkout Feature Testing
  ...
  # Scenario TC-04-02 Test continue checkout with fills all fields in checkout information page
  Scenario: Test continue checkout with fills all fields in checkout information page
    Given the user is logged in to the application with username "standard_user" and password "secret_sauce"
    And the user is on the Dashboard page
    And the user clicks on the 'Add to Cart' button for 'Sauce Labs Backpack'
    When the user clicks the "shopping cart" button on the "dashboard" page
    ...
    # Scenario TC-04-03 Test continue checkout without fills all fields in checkout information page
    Scenario: Test continue checkout without fills all fields in checkout information page
      Given the user is logged in to the application with username "standard_user" and password "secret_sauce"
      And the user is on the Dashboard page
      And the user clicks on the 'Add to Cart' button for 'Sauce Labs Backpack'
      When the user clicks the "shopping cart" button on the "dashboard" page
