Feature: Menu Page Testing
  ...
  # Scenario TC-06-01 Test menu All items in navigation bar menu
  ...
  # Scenario TC-06-02 Test menu About in navigation bar menu
  ...
  # Scenario TC-06-03 Test menu Logout in navigation bar menu
